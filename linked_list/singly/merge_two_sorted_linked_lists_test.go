...
func Test_MergeTwoSortedLinkedLists(t *testing.T) {
	...
	mergedList := MergeTwoSortedLinkedListsRecursively(list1.head, list2.head)
...
func Test_MergeTwoSortedLinkedListsIteration(t *testing.T) {
	list1 := SinglyLinkedList[int]{}
	list1.AddNode(1)
	list1.AddNode(3)
	list1.AddNode(5)
	...
	mergedList := MergeTwoSortedLinkedListsIteration(list1.head, list2.head)
